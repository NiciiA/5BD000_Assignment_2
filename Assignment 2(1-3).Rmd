...
missing_ids <-setdiff(all_ids, cleaned_ids)
missing_ids

d[d$id %in% missing_ids,]
```
...
```{r}
# (c) 
# This is the number of total persons included
n_total <- nrow(d)
n_total

# this is the number of people with no na values.
n_total_na_removed <- nrow(dc)
n_total_na_removed
