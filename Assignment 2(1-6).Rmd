...
The benefit is greatest at low thresholds (around 0.08–0.10), where the model’s net benefit is clearly superior to both default strategies. As the threshold increases beyond 0.20–0.25, the model’s net benefit approaches the “Treat None” strategy and provides little additional value.
...
library(rmda)
dc_dca <- dc
dc_dca$chd69 <- as.numeric(as.character(dc_dca$chd69))
...
plot_decision_curve(
  ...
  xlab              = "Risk threshold",
  ylab              = "Net benefit",
  col               = c("#D73027", "#4575B4", "grey75", "black"),  # Final / Agegroup / All / None
  lwd               = c(3, 3, 2, 2),
  lty               = c(1, 1, 2, 1),
  legend.position   = "topright",
  cex.axis          = 1.2,
